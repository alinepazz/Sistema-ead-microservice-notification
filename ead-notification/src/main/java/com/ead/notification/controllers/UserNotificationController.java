...
public class UserNotificationController {
    ...
    public ResponseEntity<Page<NotificationModel>> getAllNotificationsByUser(@PathVariable(value = "userId")
    ...
    public ResponseEntity<Object> updateNotification(@PathVariable(value = "userId")
        ...
        notificationModelOptional.get().setNotificationSatus(notificationDto.getNotificationSatus());
